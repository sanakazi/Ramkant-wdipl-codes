...
import com.debalink.adapters.DiscussionsAdapter.PlanetViewHolder;
...
public class PublicDiscussionAdapter extends BaseExpandableListAdapter {
	...
	ArrayList<ArrayList<DiscussionModel>> childItem;
	...
	public PublicDiscussionAdapter(Activity activity, ArrayList<String> grList, ArrayList<ArrayList<DiscussionModel>> childItem) {
		groupItem = grList;
	...
	public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		DiscussionModel planet = (DiscussionModel) childItem.get(groupPosition).get(childPosition);
		...
		txtUserName.setText(planet.getUserName());
		txtDateTime.setText(planet.getCreatedDate());
		txtDesc.setText(planet.getDiscussinTitle());
