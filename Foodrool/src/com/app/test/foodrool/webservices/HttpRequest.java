package com.app.test.foodrool.webservices;
...
public class HttpRequest {
	String URL = "http://foodrool.com/WebService.asmx";
	//String URL = "http://dev.foodrool.com/WebService.asmx";
	//String URL="http://192.168.1.225:108/webservice.asmx";
